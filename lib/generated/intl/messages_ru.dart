...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(charge) => "Заряд батареи: ${charge}%";

  static String m1(app) => "Перейти в ${app}";

  static String m2(price) => "Пауза: ${price}/мин";

  static String m3(price) => "Цена: ${price}/мин";

  static String m4(price) => "Бронирование: ${price}/мин";

  static String m5(price) => "Старт: ${price}";

  static String m6(count) => "Велосипедов: ${count}";

  static String m7(count) => "Электрических: ${count}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "geolocationPermissionDenied": MessageLookupByLibrary.simpleMessage(
            "Нет разрешения на геолокацию, вы не можете увидеть свое местоположение."),
        ...
        "homeBikeFAB":
            MessageLookupByLibrary.simpleMessage("Фильтр велосипедов"),
        "homeCarFAB": MessageLookupByLibrary.simpleMessage("Фильтр машин"),
        "homeScooterFAB":
            MessageLookupByLibrary.simpleMessage("Фильтр самокатов"),
        ...
        "introFifthScreenBody": MessageLookupByLibrary.simpleMessage(
            "Войдите в систему с помощью своей учетной записи Google. Ваши предпочтения сохраняются для обеспечения последовательного, персонализированного опыта каждый раз, когда вы используете Yggert Nu."),
        "introFifthScreenHeader":
            MessageLookupByLibrary.simpleMessage("Сохраните свои предпочтения"),
        "introFirstScreenBody": MessageLookupByLibrary.simpleMessage(
            "Испытайте революцию в городской мобильности. Интегрируйте свои путешествия с арендой скутеров, велосипедов, автомобилей и общественного транспорта, все в одном приложении."),
        "introFirstScreenHeader": MessageLookupByLibrary.simpleMessage(
            "Добро пожаловать в Yggert Nu!"),
        "introFourthScreenBody": MessageLookupByLibrary.simpleMessage(
            "Выберите свой предпочитаемый город, переключите тему на светлую или темную, выберите свой язык. Настройте свой опыт с помощью наших легко доступных настроек."),
        "introFourthScreenHeader":
            MessageLookupByLibrary.simpleMessage("Настройте по своему вкусу"),
        "introSecondAndHalfScreenBody": MessageLookupByLibrary.simpleMessage(
            "Обратите внимание, что Yggert Nu агрегирует данные из различных транспортных приложений, и бронирование происходит через приложение соответствующего поставщика, которое должно быть установлено на вашем устройстве."),
        "introSecondAndHalfScreenHeader": MessageLookupByLibrary.simpleMessage(
            "Унифицированные транспортные услуги"),
        "introSecondScreenBody": MessageLookupByLibrary.simpleMessage(
            "Найдите самый быстрый и удобный способ передвижения, подходящий именно Вам. Все доступные арендные услуги и варианты общественного транспорта интегрированы на одной удобной карте."),
        "introSecondScreenHeader": MessageLookupByLibrary.simpleMessage(
            "Все Ваши варианты транспорта в одном месте"),
        "introSixthScreenBody": MessageLookupByLibrary.simpleMessage(
            "Добро пожаловать в более умный, более интегрированный мир транспорта. Начните свое путешествие с Yggert Nu сейчас!"),
        "introSixthScreenHeader":
            MessageLookupByLibrary.simpleMessage("Готовы к путешествию?"),
        "introThirdScreenBody": MessageLookupByLibrary.simpleMessage(
            "Больше никогда не пропустите автобус. Проверьте местные автобусные остановки для просмотра ближайших расписаний и прибытий, когда рядом нет непосредственного транспорта."),
        "introThirdScreenHeader":
            MessageLookupByLibrary.simpleMessage("Всегда будьте вовремя"),
        "jarvamaa": MessageLookupByLibrary.simpleMessage("Ярвамаа"),
        "johvi": MessageLookupByLibrary.simpleMessage("Йыхви"),
        "kohtlaJarve": MessageLookupByLibrary.simpleMessage("Кохтла-Ярве"),
        "kuressaare": MessageLookupByLibrary.simpleMessage("Курессааре"),
        "light": MessageLookupByLibrary.simpleMessage("Светлая"),
        "mapScreenGpsFAB":
            MessageLookupByLibrary.simpleMessage("Получить геолокацию"),
        "microMobilityCouldNotLoad": MessageLookupByLibrary.simpleMessage(
            "Не получилось загрузить нужную информацию."),
        ...
        "narva": MessageLookupByLibrary.simpleMessage("Нарва"),
        "noButton": MessageLookupByLibrary.simpleMessage("Нет"),
        "onboardingBodyTextCity": MessageLookupByLibrary.simpleMessage(
            "Город, для которого загружены данные"),
        "onboardingBodyTextCustomize": MessageLookupByLibrary.simpleMessage(
            "Нажмите, чтобы настроить настройки карты"),
        "onboardingBodyTextFiltersExample":
            MessageLookupByLibrary.simpleMessage(
                "Например, эта кнопка показывает/скрывает самокаты"),
        "onboardingBodyTextRefresh": MessageLookupByLibrary.simpleMessage(
            "Нажмите, чтобы обновить маркеры"),
        "onboardingTitleTextCity":
            MessageLookupByLibrary.simpleMessage("Выбранный город"),
        "onboardingTitleTextFilters":
            MessageLookupByLibrary.simpleMessage("Используйте фильтры"),
        "onboardingTitleTextGoodLuck":
            MessageLookupByLibrary.simpleMessage("Удачи на дороге!"),
        ...
        "settingsGlobalFilterAll":
            MessageLookupByLibrary.simpleMessage("Показать все"),
        "settingsGlobalFilterToday":
            MessageLookupByLibrary.simpleMessage("Показать на сегодня"),
        "settingsGtfsFileWasDownloaded":
            MessageLookupByLibrary.simpleMessage("Файл GTFS был загружен"),
        "settingsLanguageEnglish":
            MessageLookupByLibrary.simpleMessage("Английский"),
        "settingsLanguageEstonian":
            MessageLookupByLibrary.simpleMessage("Эстонский"),
        ...
        "settingsNoGtfsFile":
            MessageLookupByLibrary.simpleMessage("GTFS файлы не найдены"),
        "showScootersLowerCharge": MessageLookupByLibrary.simpleMessage(
            "Показывать самокаты с зарядом меньше 30%?"),
        "signInWithGoogle":
            MessageLookupByLibrary.simpleMessage("Войти через Google"),
        "snackbarCantFetchBoltScootersData":
            MessageLookupByLibrary.simpleMessage(
                "Ошибка сервера. Невозможно загрузить данные о Bolt самокатах."),
        "snackbarCantFetchHoogScootersData":
            MessageLookupByLibrary.simpleMessage(
                "Ошибка сервера. Невозможно загрузить данные о Hoog самокатах."),
        "snackbarCantFetchTartuSmartBikeData": MessageLookupByLibrary.simpleMessage(
            "Ошибка сервера. Невозможно загрузить данные о велосипедах Tartu Smart bike."),
        "snackbarCantFetchTuulScootersData":
            MessageLookupByLibrary.simpleMessage(
                "Ошибка сервера. Невозможно загрузить данные о Tuul самокатах."),
        "snackbarCityIsNotPicked":
            MessageLookupByLibrary.simpleMessage("Город не выбран"),
        ...
        "snackbarNoGtfsFileIsPresent": MessageLookupByLibrary.simpleMessage(
            "GTFS файлов нет, нажмите кнопку обновить для загрузки."),
        "snackbarNoInternetConnection": MessageLookupByLibrary.simpleMessage(
            "Нет интернет-соединения. Пожалуйста проверьте его, нажмите на иконку \'Обновить\' и попробуйте снова."),
        "snackbarNoInternetConnectionInSettings":
            MessageLookupByLibrary.simpleMessage(
                "Нет интернет-соединения. Пожалуйста проверьте его и попробуйте снова."),
        "snackbarNoNeedToDownload": MessageLookupByLibrary.simpleMessage(
            "У вас самые свежие GTFS данные."),
        "someErrorOccurred": MessageLookupByLibrary.simpleMessage(
            "Произошла неизвестная ошибка. Попробуйте снова позже."),
        "startTutorialAgain":
            MessageLookupByLibrary.simpleMessage("Начать обучение снова?"),
        "stopMarkerShowAllForwardStoptimesButton":
            MessageLookupByLibrary.simpleMessage("Показать остановки"),
        "stopSearchHintText":
            MessageLookupByLibrary.simpleMessage("Введите название остановки"),
