...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(charge) => "Aku laetuse tase: ${charge}%";

  static String m1(app) => "Mine ${app} rakendusse";

  static String m2(price) => "Pause hind: ${price}/min";

  static String m3(price) => "Hind: ${price}/min";

  static String m4(price) => "Broneeri ${price}/min";

  static String m5(price) => "Start hind: ${price}";

  static String m6(count) => "Jalgrattad: ${count}";

  static String m7(count) => "Pedelec jalgrattad: ${count}";
