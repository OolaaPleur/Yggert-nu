...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(charge) => "Battery Charge: ${charge}%";

  static String m1(app) => "Go to ${app} app";

  static String m2(price) => "Pause price: ${price}/min";

  static String m3(price) => "Price: ${price}/min";

  static String m4(price) => "Reserve ${price}/min";

  static String m5(price) => "Start price: ${price}";

  static String m6(count) => "Bikes: ${count}";

  static String m7(count) => "Pedelec Bikes: ${count}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "homeScooterFAB":
            MessageLookupByLibrary.simpleMessage("Scooters filter"),
        ...
        "introFifthScreenHeader":
            MessageLookupByLibrary.simpleMessage("Save Your Preferences"),
        ...
        "introFirstScreenHeader":
            MessageLookupByLibrary.simpleMessage("Welcome to the Yggert Nu!"),
        ...
        "introFourthScreenHeader":
            MessageLookupByLibrary.simpleMessage("Customize to Your Liking"),
        ...
        "introSecondAndHalfScreenHeader":
            MessageLookupByLibrary.simpleMessage("Unified Transport Services"),
        ...
        "introSixthScreenHeader":
            MessageLookupByLibrary.simpleMessage("Ready for the Journey?"),
        ...
        "introThirdScreenHeader":
            MessageLookupByLibrary.simpleMessage("Always Be on Time"),
        ...
        "mapScreenGpsFAB":
            MessageLookupByLibrary.simpleMessage("Get geolocation"),
        ...
        "onboardingBodyTextRefresh":
            MessageLookupByLibrary.simpleMessage("Tap to refresh markers"),
        "onboardingTitleTextCity":
            MessageLookupByLibrary.simpleMessage("Picked city"),
        "onboardingTitleTextFilters":
            MessageLookupByLibrary.simpleMessage("Use filters"),
        "onboardingTitleTextGoodLuck":
            MessageLookupByLibrary.simpleMessage("Good luck on the road!"),
        ...
        "settingsGlobalFilterToday":
            MessageLookupByLibrary.simpleMessage("Show for today"),
        "settingsGtfsFileWasDownloaded":
            MessageLookupByLibrary.simpleMessage("GTFS file was downloaded "),
        "settingsLanguageEnglish":
            MessageLookupByLibrary.simpleMessage("English"),
        "settingsLanguageEstonian":
            MessageLookupByLibrary.simpleMessage("Estonian"),
        "settingsLanguageRussian":
            MessageLookupByLibrary.simpleMessage("Russian"),
        ...
        "settingsNoGtfsFile":
            MessageLookupByLibrary.simpleMessage("No GTFS file"),
        ...
        "snackbarCityIsNotPicked":
            MessageLookupByLibrary.simpleMessage("No city was picked."),
        ...
        "stopMarkerShowAllForwardStoptimesButton":
            MessageLookupByLibrary.simpleMessage("Press to see stoptimes"),
        "stopSearchHintText":
            MessageLookupByLibrary.simpleMessage("Enter stop name"),
