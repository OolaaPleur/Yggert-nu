...
class SettingsRepository {
  ...
  Future<bool> setStringValue(String valueKey, String value) => _deviceSettings.setStringValue(valueKey, value);
  /// Function save bool [value] for specified [valueKey] in shared preferences.
  Future<bool> setBoolValue(String valueKey, {bool? value}) => _deviceSettings.setBoolValue(valueKey, value: value);
