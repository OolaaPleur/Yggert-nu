  ...
  Future<(List<TuulScooter> boltScootersList, {String pricePerMinute, String startPrice, String reservePrice})>  getTuulScooters(String pickedCity) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(apiLinks.tuulScooterLink).replace(queryParameters: param),
      );
      if (response.statusCode == 200) {
        ...
        try {
          ...
          final vehicles = vehiclesData
              ...
              .toList();
          return (vehicles, pricePerMinute: pricePerMinute, startPrice: startPrice, reservePrice: reservePrice);
        } catch (e) {
          rethrow;
        }
      } else {
